...
class AccountSettingsActivity : BaseActivity<ActivityAccountSettingsBinding>() {
    ...
    override fun getViewBinding(): ActivityAccountSettingsBinding {
        return ActivityAccountSettingsBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ThemeManager.isDarkMode(this)) {
            ...
            binding.lottieAccountSettings.addValueCallback(
                KeyPath("**"),
